...
We'll touch upon both the dreams of conceiving intelligence, and the consequences of concrete applications
...
![The 1956 proposal for the Dartmouth workshop](../assets/dartmouth_workshop.png)
...
![Joseph Weizenbaum programming ELIZA in 1964](../assets/eliza_weizenbaum.webp)
...
The Lighthill report is particularly damning.
...
![Meanwhile, Frank Rosenblatt works on the Perceptron in 1950](../assets/rosenblatt.webp)
...
Datasets of pictures of streets and roads needs to have labels that describe them as pictures of cars, sidewalk, crosswalks, firehydrants, scooters, etc. You can see image datasets made by Google [here](https://storage.googleapis.com/openimages/web/visualizer/index.html?type=localized%20narratives&set=train&c=%2Fm%2F0191f8). Notice how all the audio associated with it includes accents from the Global South.

This is done through services like [Amazon Mechanical Turk](https://www.mturk.com), which provides a global workforce of disposable workers doing these menial tasks. The name is inspired by the late 18th century [Automated Chess Player](https://en.wikipedia.org/wiki/Mechanical_Turk) which pretended to be robot playing chess, but was hiding beneath was a real human.

There are some artistic projects trying to visibilize these "click workers": [the middle finger response](https://www.crowdworkersoftheworldunite.com/#wrapper) and [mturk poems](https://www.instagram.com/mturkpoems/).
